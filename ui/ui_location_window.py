...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lblRuta.setText(QCoreApplication.translate("Dialog", u"Ruta/NAS", None))
        self.btnExaminar.setText(QCoreApplication.translate("Dialog", u"Examinar", None))
        self.lblConservar.setText(QCoreApplication.translate("Dialog", u"Eliminar backups anteriores despu\u00e9s de:", None))
        self.lblMes.setText(QCoreApplication.translate("Dialog", u"Meses", None))
        self.lblDias.setText(QCoreApplication.translate("Dialog", u"D\u00edas", None))
        self.groupBox.setTitle(QCoreApplication.translate("Dialog", u"Configuraci\u00f3n avanzada NAS/Carpeta en red", None))
        ...
        self.lblPass.setText(QCoreApplication.translate("Dialog", u"Contrase\u00f1a", None))
    # retranslateUi
